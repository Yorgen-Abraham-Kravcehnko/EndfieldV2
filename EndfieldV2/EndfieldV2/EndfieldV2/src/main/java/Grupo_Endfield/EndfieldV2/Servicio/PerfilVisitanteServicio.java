...
public class PerfilVisitanteServicio {
    ...
    public PerfilVisitante actualizar(Integer id, PerfilVisitante perfilVisitante) {
    PerfilVisitante existente = perfilVisitanteRepositorio.findById(id)
        .orElseThrow(() -> new RuntimeException("Perfil de visitante no encontrado."));
    existente.setTipoPerfil(perfilVisitante.getTipoPerfil());
    existente.setDescripcion(perfilVisitante.getDescripcion());
    return perfilVisitanteRepositorio.save(existente);
}
}