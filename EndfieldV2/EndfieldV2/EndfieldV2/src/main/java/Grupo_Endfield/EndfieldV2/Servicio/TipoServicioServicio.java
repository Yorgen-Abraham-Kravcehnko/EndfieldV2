...
public class TipoServicioServicio {
    ...
    public TipoServicio actualizar(Integer id, TipoServicio tipoServicio) {
    TipoServicio existente = tipoServicioRepositorio.findById(id)
    ...
    existente.setCategoriaServicio(tipoServicio.getCategoriaServicio());
    return tipoServicioRepositorio.save(existente);
}
}